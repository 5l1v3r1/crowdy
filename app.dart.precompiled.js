...
if(z!=null)z.Ii.setAttribute("class","")
if(this!==z){$.R0=this
this.Ii.setAttribute("class","selected")}else $.R0=null},"call$1","gDB",2,0,2],
...
if($desc instanceof Array)$desc=$desc[1]
dX.prototype=$desc
function OT(Ii,If,ol){this.Ii=Ii
this.If=If
