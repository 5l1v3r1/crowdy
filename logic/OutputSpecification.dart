...
class OutputSpecificationUI {
  ...
  void addElement(String identifier,
    ...
    this.elements['segment-${identifier}'] = newElement;
    this.elementList.append(newElement.getFormElement(example));
  }
  
  void removeElement(String identifier) {
    this.elements['segment-${identifier}']._remove();
    this.elements.remove('segment-${identifier}');
  }
  ...
  void refreshSpecification (Iterable<OutputSegmentUI> segments) { }
}
...
class SelectionOutputSpecificationUI extends OutputSpecificationUI {
  ...
  void refreshSpecification (Iterable<OutputSegmentUI> segments) {
    this.clear();
    for (OutputSegmentUI segment in segments) {
      this.addElement('${this.id}-segment-${segment.hashCode}', defaultName: segment.name.text, editable: false);
    }
  }
}