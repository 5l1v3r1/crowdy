...
demonstrated via the tool that available \url{http://crowdy.herokuapp.com}. The 
minimal example application presented earlier in this section is implemented. 
The steps are presented and explained in detail with the sample screenshots from the tool.
...
On the right (pointed by (2)), the list of operators is given and that list is separated by operator 
