...
\anahtarsoz{Kitle kaynak}

\title{CROWDY\\A FRAMEWORK FOR SUPPORTING SOCIO-TECHNICAL SOFTWARE ECOSYSTEMS WITH STREAM-BASED HUMAN COMPUTATION}
\baslik{CROWDY\\SOSYAL VE TEKN{\.I}K YAZILIM EKOS{\.I}STEMLER{\.I}N{\.I} D{\.I}NAM{\.I}K K{\.I}TLE KAYNAK {\.I}LE DESTEKLEYEN UYGULAMA} 

\author{Mert Emin Kalender}
\dept{Computer Engineering}
\bolum{Bilgisayar M\"{u}hendisli\u{g}i}
\principaladvisor{Asst. Prof. Dr. Bedir Tekinerdo\u{g}an}
\tezyoneticisi{Dr. Bedir Tekinerdo\u{g}an}
\firstreader{Asst. Prof. Dr. Bu\u{g}ra Gedik}
\secondreader{Assoc. Prof. Halit O\u{g}uzt\"{u}z\"{u}n}
\director{Prof. Dr. Levent Onural}
%\copyrightyear{2011}
\submitdate{August, 2014}
\tarih{A\u{g}ustos, 2014}
